...
class Raytracer:
    ...
    def shade(self, hit_point, normal, hit_object, view_dir):
        """Compute Phong shading with procedural textures."""
        ...
        for i, row in enumerate(self.focal_plane):
            ...
            for j, pixel_world in enumerate(row):
                ...
                if self.kdtree is not None:
                    ...
                    # Brute-force: loop over all triangles
                ...
                if hit_material is None:
                    ...
                    color = self.shade(hit_point, hit_normal, hit_object, view_dir)
