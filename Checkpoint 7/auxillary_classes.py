...
class Material:
    def __init__(self, diffuse_color, specular_color, ka, kd, ks, ke,
                 ...
                 mapping_type='plane', color1=None, color2=None, kr=0.0, kt=0.0, ior=1.0, ior_outside=1.0):
        ...
        self.ior = ior                   # inner IOR
        self.ior_outside = ior_outside   # outer IOR

        # Texture properties (unchanged)
        ...
        if texture_type == 'image' and texture_image_path:
            ...
            self.texture_image = np.array(img) / 255.0
